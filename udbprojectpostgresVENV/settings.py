"""
Django settings for udbprojectpostgresVENV project.
...
SECRET_KEY = 'h(=dtculk_--j6h*0uw$!sr65@00mo05zj(9&h(==yr8btb8-$'
...
ROOT_URLCONF = 'udbprojectpostgresVENV.urls'

WSGI_APPLICATION = 'udbprojectpostgresVENV.wsgi.application'
